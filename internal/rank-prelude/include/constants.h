...
#define RANK_MAR_TIMEOUT_VALUE 2min
#define RANK_BID_TIMEOUT_VALUE 2min
#define RANK_AUCT_TIMEOUT_VALUE 2min
#define RANK_REP_TIMEOUT_VALUE 1min

#define RANK_MAX_PRIORITY 8
#define RANK_CURRENT_RESOURCES_EVAL_THRESHOLD (2/3)
#define RANK_PROXIMITY_EVAL_RTT_THRESHOLD 100
#define RANK_PROXIMITY_EVAL_PDV_THRESHOLD 30
#define RANK_PROXIMITY_EVAL_PDV_TOLERANCE 0.3
#define RANK_PROXIMITY_EVAL_PL_THRESHOLD 10

#ifdef PL_STEEP
#define RANK_PROXIMITY_EVAL_PL_STEEP 1
#elif PL_SMOOTH
#define RANK_PROXIMITY_EVAL_PL_SMOOTH 3
#else
#define RANK_PROXIMITY_EVAL_PL_LINEAR 2
#endif

#define RANK_DURATION_OLD 60
