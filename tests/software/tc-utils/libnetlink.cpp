                     ...
                     req_filter_fn_t filter_fn)
{
 struct {
   ...
   char buf[128];
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ifm.ifa_family = static_cast<__u8>(family),
 };
...
int rtnl_addrlbldump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   struct ifaddrlblmsg ifal;
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ifal.ifal_family = static_cast<__u8>(family),
 };
                      ...
                      req_filter_fn_t filter_fn)
{
 struct {
   ...
   char buf[128];
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .rtm.rtm_family = static_cast<unsigned char>(family),
 };
...
int rtnl_ruledump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   struct fib_rule_hdr frh;
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .frh.family = static_cast<__u8>(family)
 };
                      ...
                      req_filter_fn_t filter_fn)
{
 struct {
   ...
   char buf[256];
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ndm.ndm_family = static_cast<__u8>(family),
 };
...
int rtnl_neightbldump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   struct ndtmsg ndtmsg;
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ndtmsg.ndtm_family = static_cast<__u8>(family),
 };
...
int rtnl_mdbdump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   struct br_port_msg bpm;
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .bpm.family = static_cast<__u8>(family),
 };
...
int rtnl_brvlandump_req(struct rtnl_handle *rth, int family, __u32 dump_flags)
{
 struct {
   ...
   char buf[256];
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .bvm.family = static_cast<__u8>(family),
 };
...
int rtnl_netconfdump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   char buf[0] __aligned(NLMSG_ALIGNTO);
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ncm.ncm_family = static_cast<__u8>(family),
 };
                               ...
                               req_filter_fn_t filter_fn)
{
 struct {
   ...
   char buf[1024];
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .rtm.rtgen_family = static_cast<unsigned char>(family),
 };
 int err;
...
static int __rtnl_linkdump_req(struct rtnl_handle *rth, int family)
{
 struct {
   ...
   struct ifinfomsg ifm;
     ...
     .nlh.nlmsg_flags = NLM_F_DUMP | NLM_F_REQUEST,
     .nlh.nlmsg_seq = rth->dump = ++rth->seq,
     .ifm.ifi_family = static_cast<unsigned char>(family),
 };
...
{
 struct rtattr *nest = static_cast<struct rtattr*>((void*)((char *)start + NLMSG_ALIGN(start->rta_len)));
